...
function [G,O,D,GD,T,Gt,Ot,Dt,GDt,Tt,kOct,kGt] = modfsys2DB_sym(conf)
...
for i=1:ntime
    ...
    D(2:round(sz/2),2:round(sz/2)) =  D(2:round(sz/2),2:round(sz/2)) -kG(2:round(sz/2),2:round(sz/2)).*dt.*D(2:round(sz/2),2:round(sz/2)).*G(2:round(sz/2),2:round(sz/2)) + kT(2:round(sz/2),2:round(sz/2)).*dt.*T(2:round(sz/2),2:round(sz/2)) -kA(2:round(sz/2),2:round(sz/2)).*D(2:round(sz/2),2:round(sz/2))*dt;
    ...
    T(2:round(sz/2),2:round(sz/2)) =  T(2:round(sz/2),2:round(sz/2)) +kO(2:round(sz/2),2:round(sz/2)).*dt.*O(2:round(sz/2),2:round(sz/2)).*GD(2:round(sz/2),2:round(sz/2)) - kT(2:round(sz/2),2:round(sz/2)).*dt.*T(2:round(sz/2),2:round(sz/2)) + kA(2:round(sz/2),2:round(sz/2)).*D(2:round(sz/2),2:round(sz/2))*dt;
