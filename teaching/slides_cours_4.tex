...
Dans la section précédente, nous avons étudié un filtre récursif et un filtre non-récursif \\
\vspace{0.3cm}
...
\vspace{1.3cm}
\only<2->{
On a étudié les propriétés de filtres existants mais on ne sait pas comment les "fabriquer" \only<2->{$\rightarrow$ Synthèse de filtre}
}
...
\end{center}
\only<2->{
\small Objectif : calculer les \textbf{coefficients de la réponse impulsionnelle} qui correspondent au gabarit
}

\column{60mm}
\underline{filtre récursif}:
\begin{center}
	\begin{tikzpicture}
	\draw (2.15,0) node {$x[n]$};
...
\only<2->{
\small Objectif : \textbf{discrétiser un filtre continu} qui corresponde au gabarit
}
...
\column{60mm}
\only<3->{
Cette réponse en amplitude va correspondre à une \textbf{réponse impulsionnelle}...\\
\vspace{0.5cm}
Comment l'obtenir ?
...
\begin{scope}[scale=0.4]
	\draw[->] (-7,0)-- (7,0);
\draw (-0.3,-0.6) node {\footnotesize{$0$}};
\draw[->] (0,0)-- (0,3);
\draw (7.6,-0.25) node {\scriptsize{$\nu$}};
\draw (0,3.5) node {\scriptsize{$|H(\nu)|$}};

\draw (3,-0.6) node {\scriptsize{$\frac{\nu_e}{2}$}};
...
\draw[dashed,blue](2,3)--(2,0.3)--(3,0.3);
	...
	\draw[thick,red]   (-3,0)--(-1.5,0)--(-1.5,2)--(1.5,2)--(1.5,0)--(3,0);
	\draw[dashed,thick,red]   (-3-6,0)--(-1.5-6,0)--(-1.5-6,2)--(1.5-6,2)--(1.5-6,0)--(3-6,0);
	\draw[dashed,thick,red]   (-3+6,0)--(-1.5+6,0)--(-1.5+6,2)--(1.5+6,2)--(1.5+6,0)--(3+6,0);
	\draw (1.5,-0.6) node {\scriptsize{$\frac{\nu_e}{4}$}};
\end{scope}
\end{tikzpicture}
\end{center}
\only<2->{
\footnotesize{Le spectre du signal est une fonction périodique.}\\
}
...
\draw[->] (0,0)-- (0,1.5)node[right]{\scriptsize{$h[n]$}};

%\draw[dotted,thick, domain=-2.4:2.4,color=red,samples=80] plot (\x,{160*sin(5*3.14*\x r  )/(5*3.14*\x r)});
\draw[thick, domain=-2.4:2.4,color=red,samples=31] plot [ycomb] (\x,{80*sin(5*3.14*\x r  )/(5*3.14*\x r)});
\end{scope}
\end{tikzpicture}
\end{center}
\footnotesize{En développant en série de Fourier la fonction périodique en fréquence on obtient des \textbf{échantillons dans le domaine temporel}}
}
...
\draw[dashed,blue](2,3)--(2,0.3)--(3,0.3);
	...
	\draw[thick,red]   (-7,0)--(-1.5,0)--(-1.5,2)--(1.5,2)--(1.5,0)--(7,0);
	%\draw[dashed,thick,red]   (-3-6,0)--(-1.5-6,0)--(-1.5-6,2)--(1.5-6,2)--(1.5-6,0)--(3-6,0);
	%\draw[dashed,thick,red]   (-3+6,0)--(-1.5+6,0)--(-1.5+6,2)--(1.5+6,2)--(1.5+6,0)--(3+6,0);
	\draw (1.5,-0.6) node {\scriptsize{$\frac{\nu_e}{4}$}};
\end{scope}
...
\end{center}
\only<2->{
\footnotesize{On "convertit" le spectre périodique en spectre "simple"}\\
}
...
\draw (0,-0.3) node {\scriptsize{0}};
\draw[->] (0,0)-- (0,1.5)node[right]{\scriptsize{$h(t)$}};

%\draw[dotted,thick, domain=-2.4:2.4,color=red,samples=80] plot (\x,{160*sin(5*3.14*\x r  )/(5*3.14*\x r)});
\draw[thick, domain=-2.4:2.4,color=red,samples=300] plot  (\x,{80*sin(5*3.14*\x r  )/(5*3.14*\x r)});
\end{scope}
\end{tikzpicture}
\end{center}
\footnotesize{On obtient un signal temporel continu... }
}
...
%\draw[dotted,thick, domain=-2.4:2.4,color=red,samples=80] plot (\x,{160*sin(5*3.14*\x r  )/(5*3.14*\x r)});
\draw[thick, domain=-2.4:2.4,color=red,samples=31] plot[ycomb]  (\x,{80*sin(5*3.14*\x r  )/(5*3.14*\x r)});
\draw[thick,dotted, domain=-2.4:2.4,color=red,samples=300] plot  (\x,{80*sin(5*3.14*\x r  )/(5*3.14*\x r)});
\end{scope}
\end{tikzpicture}
\end{center}
\footnotesize{On obtient un signal temporel continu... qu'on échantillonne}
}
...
\begin{frame}
\frametitle{Premier exemple :  Filtre passe-bas idéal}
\underline{Résultat des 2 méthodes}:\\
\vspace{0.3cm}
\begin{columns}
...
\vspace{0.5cm}
\only<1>{\[ H^*(\nu) = ?  \]}
\only<2->{\[\boxed{ H^*(\nu) = TF(\frac{\sin(\pi nT_e)}{\pi n T_e}) \star TF(\Pi_M[n])}  \]}
...
\begin{center}
\begin{tikzpicture}
\draw[->] (-2.5,0)-- (2.5,0) node[right]{\footnotesize{$n$}};
\draw (0,-0.3) node {0};
\draw[->] (0,0)-- (0,3)node[right]{\footnotesize{$h^*[n]$}};
...
\begin{tikzpicture}
	...
	\draw[->] (-0.5,0)-- (3,0)node[right] {\footnotesize{$_nu$}};
\draw (0,-0.3) node {0};
\draw[->] (0,0)-- (0,3) node[right] {\footnotesize{$H^*(\nu)$}};
...
\begin{tikzpicture}
	...
	\draw[->] (-0.5,0)-- (3,0)node[right] {\footnotesize{$\nu$}};
\draw (0,-0.3) node {0};
\draw[->] (0,0)-- (0,3) node[right] {\footnotesize{$H^*(\nu)$}};
...
On résume :
\begin{itemize}
\item<2-> Réponse impulsionnelle du passe-bas idéal ? \only<3->{ sinus cardinal discret (nombre infini de termes)}
\vspace{0.3cm}
...
Commentaires:
\begin{itemize}
\item<2-> Filtre réel (nombre fini de termes) = \textbf{Oscillations rép. en fréq.}
\vspace{0.3cm}
\item<3-> Oscillations = tolérance en amplitude + largeur de transition
\vspace{0.3cm}
\item<4-> + de termes = - d'oscillations MAIS mémoire et temps de calcul à prendre en compte
\vspace{0.3cm}
\item<5-> \textbf{Ondulations de même amplitude en bande passante et affaiblie...}
\end{itemize}
\end{columns}
...
\begin{tikzpicture}
\begin{scope}[scale=0.3]
	\draw[->] (-0.5,0)-- (3.5,0)node[right] {\scriptsize $\nu$} ;
%\draw (-0.3,-0.3) node {0};
\draw[->] (0,0)-- (0,3)node[above] {\scriptsize $|H(\nu)|$};
...
\draw[thick, domain=-1.45:1.45,color=red,samples=21] plot [ycomb] (\x,{120*sin(5*3.14*\x r  )/(5*3.14*\x r)});
	...
	\draw[->] (-0.5,0)-- (3,0)node[right] {\scriptsize $\nu$};
%\draw (0,-0.5) node {0};
\draw[->] (0,0)-- (0,3) node[right] {\scriptsize $H^*(\nu)$};
...
\draw[thick, domain=-1.45:1.45,color=red,samples=21] plot [ycomb] (\x,{120*sin(5*3.14*\x r  )/(5*3.14*\x r)});
	...
	\draw[->] (-0.5,0)-- (3,0)node[right] {\scriptsize $\nu$};
%\draw (0,-0.5) node {0};
\draw[->] (0,0)-- (0,3.5) node[right] {\scriptsize $H^*(\nu)$};
...
\vspace{0.2cm}
\begin{itemize}
\item Plusieurs fenêtres sont possibles (Hamming, Dolph-Tchebycheff,...)
\vspace{0.2cm}
...
\begin{tikzpicture}
		...
		\node[rectangle,draw,align=center] (B) at (10,0) {$H^*(\nu)$};	
...
\begin{center}
\begin{tikzpicture}
\draw[->] (-2.1,0)-- (2.1,0)node[right] {\scriptsize $\nu$} ;
\draw[->] (0,0)-- (0,1.5)node[above] {\scriptsize  $|H(\nu)|$};
\draw[thick,blue] plot file {module_freq_samp.txt};

\begin{scope}[yshift=-2.5cm]
\draw[->] (-2.1,0)-- (2.1,0)node[right] {\scriptsize $\nu$} ;
\draw[->] (0,0)-- (0,1.5)node[above] {\scriptsize $\textrm{arg}(H(\nu))$};
...
\begin{tikzpicture}
\begin{scope}[scale=2]
\draw[->] (-2.1,0)-- (2.1,0)node[right] {\footnotesize{ $\nu$}} ;
\draw[->] (0.02,0)-- (0.02,1.5)node[above] { \footnotesize{ $|H(\nu)|$}};
\draw[thick,blue] plot file {module_freq_samp.txt};
...
\draw[->] (-2.1,0)-- (2.1,0)node[right] {\scriptsize $\nu$} ;
\draw[->] (0.02,0)-- (0.02,1.5)node[above] {\scriptsize  $|H(\nu)|$};
\draw[thick,blue] plot file {module_freq_samp.txt};
...
\draw[color=blue!50!cyan] (1.2,-1.25)--(1.4,-1.25) node[right,color=black] {\scriptsize $a<<1$};
\draw[color=blue] (1.2,-1)--(1.4,-1) node[right,color=black] {\scriptsize $a>>1$};
\draw[dashed] (1,-0.5)node[below] {\scriptsize $\nu_e/2$}--(1,0);
\end{scope}
\end{tikzpicture}
\end{center}
}
