...
\begin{frame}
\frametitle{Synthèse de filtres récursifs: Différentes méthodes}
Les méthodes suivent toute le même principe général :
...
\vspace{0.2cm}
\only<3->{
\[  H(s) = \frac{1}{s+a} \rightarrow H(z) = \frac{1}{\frac{2}{T_e} \frac{1-z^{-1}}{1+z^{-1}}+a} =\frac{T_e(1+z^{-1})}{2(1-z^{-1}) + a(1+z^{-1})} \]
}
\vspace{0.2cm}
\only<4->{
