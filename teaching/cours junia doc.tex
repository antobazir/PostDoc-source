...
\subsection{Notion de spectre en amplitude et en phase}
...
\draw[->] (2.5,0) node[below] {0} -- (2.5,1.5)node[above] {$e(f)$};
\draw[->] (0,0)-- (5,0) node[right] {$f$};
\draw[ domain=0.1:4.9,color=blue,samples=80] plot[ycomb] (\x,{80*sin(5*3.14*\x r -5*3.14*2.5r )/(5*3.14*\x r-5*3.14*2.5 r)});
\end{scope}
\end{tikzpicture}
