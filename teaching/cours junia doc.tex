...
\[ g_5(t) = 0.55\cos(2 t) + 0.45 \cos(4 t + \frac{\pi}{3}) \] \\
...
\draw[->] (2.5,0) node[below] {0} -- (2.5,1.5)node[above] {$E(f)$};
...
\begin{tikzpicture}
\draw[->] (2.5,0) node[below] {0} -- (2.5,1.5)node[above] {$e(t)$};
\draw[->] (0,0)-- (5,0) node[right below] {$t$};
...
\draw[thick,blue] (4,-0)-- (4,-0.35);
	\end{tikzpicture}
\end{center}
Avant d'aller plus loin, il faut mentionner le critère de Shannon. Ce dernier stipule que pour échantillonner un signal sans perte d'information (ou repliement) il est nécessaire de prendre une \textbf{fréquence d'échantillonnage au moins 2 fois supérieur à la fréquence la plus élevée du signal.}

On peut maintenant aborder dans ce cas est l'impact de l'opération d'échantillonnage sur le spectre du signal:\\
...
\begin{tikzpicture}
\begin{scope}[scale =2]
\draw[->,thick] (0,0)--(0,1.5) node[left]{$|H(f)|$};
\draw[->,thick] (0,0)--(1.5,0) node[below]{$f$};
\draw (-0.2,1.1) node {$\frac{1}{1-b}$};
\draw (-0.2,0.1) node {$\frac{1}{1+b}$};
\draw[color=blue,thick](0,1.1) .. controls (0.35,1.1) and (0.35,0.1) .. (0.75,0.1);
%\draw[color=blue,thick](0.75,0.1) .. controls (1.1,0.1) and (1.1,1.1) .. (1.5,1.1);
\end{scope}


\begin{scope}[scale =2,xshift=5cm, yshift=0.7 cm]
\draw[->,thick] (0,-0.7)--(0,0.7) node[left]{$arg(H(f))$};
\draw[->,thick] (-1.2,0)--(1.2,0) node[below]{$f$};
\draw (-1,-0.2) node {$- \pi$};
\draw (1,-0.2) node {$\pi$};
\draw (0.3,-0.2) node {$\arccos(b)$};
\draw[color=blue,thick](-1.0,0) .. controls (-0.4,-0.5) and (-0.2,-0.5) .. (0,0);
\draw[color=blue,thick](0,0) .. controls (0.2,0.5) and (0.4,0.5) .. (1.0,0) ;
\end{scope}
...
\begin{tikzpicture}
\begin{scope}[scale =2]
\draw[->,thick] (0,0)--(0,1.5) node[left]{$|H_a(f)|$};
\draw[->,thick] (0,0)--(1.5,0) node[below]{$f$};
\draw[color=blue,thick](0,1.1) .. controls (0.2,1.1) and (0.2,0.2) .. (1.5,0.1);
%\draw[color=blue,thick](0.75,0.1) .. controls (1.1,0.1) and (1.1,1.1) .. (1.5,1.1);
\end{scope}

\begin{scope}[scale =2,xshift=3cm]
\draw[->,thick] (0,0)--(0,1.5) node[left]{$|H_{ech}(f)|$};
\draw[->,thick] (0,0)--(1.5,0) node[below]{$f$};
\draw[color=blue,thick](0,1.1) .. controls (0.1,1.1) and (0.1,0.4) .. (0.75,0.4);
\draw[color=blue,thick](0.75,0.4) .. controls (1.4,0.4)  and  (1.4,1.1).. (1.5,1.1);
%\draw[color=blue,thick](0.75,0.1) .. controls (1.1,0.1) and (1.1,1.1) .. (1.5,1.1);
\end{scope}
...
\begin{center}
\begin{tikzpicture}
\draw[->] (-2,0)-- (2,0) node[right] {$f_a$};
\draw (0.3,-0.3) node {0};
\draw[->] (0,-2)-- (0,2) node[right] {$f_n$};
%\draw (0.5,-0.4) node {$\frac{2}{T_e}$};

\draw[thick, domain=-1.25:1.25,color=blue,samples=30] plot (\x,{2*tan(0.75*\x r });
\end{tikzpicture}
\end{center}
