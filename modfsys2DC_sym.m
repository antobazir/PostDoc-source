...
function [G,O,D,GD,T,Gt,Ot,Dt,GDt,Tt,kOct,kGt] = modfsys2DC_sym(conf)
...
kA = zeros(round(sz/2)+1,round(sz/2)+1);
...
kA(find((dsx_s.^2+dsy_s.^2)<r^2))= kA_tissue;
...
for i=1:ntime
    ...
    %GD(find((dsx.^2+dsy.^2)>=r^2))= 1;
     ...
     kA(find((dsx_s.^2+dsy_s.^2)<r^2)) = kA_tissue*exp(-cT*T(find((dsx_s.^2+dsy_s.^2)<r^2))./ D(find((dsx_s.^2+dsy_s.^2)<r^2)));
    ...
    %x-step
    G(2:round(sz/2),2:round(sz/2)) =  G(2:round(sz/2),2:round(sz/2)) + dt*(DG(3:round(sz/2)+1,2:round(sz/2))-DG(1:round(sz/2)-1,2:round(sz/2)))/(4*dx^2).*(G(3:round(sz/2)+1,2:round(sz/2))-G(1:round(sz/2)-1,2:round(sz/2))) + DG(2:round(sz/2),2:round(sz/2))*dt/dx^2.*(G(3:round(sz/2)+1,2:round(sz/2)) -2*(G(2:round(sz/2),2:round(sz/2))) + G(1:round(sz/2)-1,2:round(sz/2))) -dx/cell_size*kG(2:round(sz/2),2:round(sz/2)).*G(2:round(sz/2),2:round(sz/2)).*D(2:round(sz/2),2:round(sz/2))*dt -dx/cell_size*kA(2:round(sz/2),2:round(sz/2)).*G(2:round(sz/2),2:round(sz/2))*dt;
    %y-step
    ...
    %x-step
    O(2:round(sz/2),2:round(sz/2)) =  O(2:round(sz/2),2:round(sz/2)) + dt*(DOx(3:round(sz/2)+1,2:round(sz/2))-DOx(1:round(sz/2)-1,2:round(sz/2)))/(4*dx^2).*(O(3:round(sz/2)+1,2:round(sz/2))-O(1:round(sz/2)-1,2:round(sz/2))) + DOx(2:round(sz/2),2:round(sz/2))*dt/dx^2.*(O(3:round(sz/2)+1,2:round(sz/2)) -2*(O(2:round(sz/2),2:round(sz/2))) + O(1:round(sz/2)-1,2:round(sz/2))) -dx/cell_size*kO(2:round(sz/2),2:round(sz/2)).*O(2:round(sz/2),2:round(sz/2)).*GD(2:round(sz/2),2:round(sz/2))*dt;
    %y-step
    ...
    GD(2:round(sz/2),2:round(sz/2)) =  GD(2:round(sz/2),2:round(sz/2)) +dx/cell_size*kG(2:round(sz/2),2:round(sz/2)).*dt.*D(2:round(sz/2),2:round(sz/2)).*G(2:round(sz/2),2:round(sz/2)) - dx/cell_size*kO(2:round(sz/2),2:round(sz/2)).*dt.*GD(2:round(sz/2),2:round(sz/2)).*O(2:round(sz/2),2:round(sz/2));
    T(2:round(sz/2),2:round(sz/2)) =  T(2:round(sz/2),2:round(sz/2)) +dx/cell_size*kO(2:round(sz/2),2:round(sz/2)).*dt.*O(2:round(sz/2),2:round(sz/2)).*GD(2:round(sz/2),2:round(sz/2)) - dx/cell_size*kT(2:round(sz/2),2:round(sz/2)).*dt.*T(2:round(sz/2),2:round(sz/2)) + dx/cell_size*kA(2:round(sz/2),2:round(sz/2)).*G(2:round(sz/2),2:round(sz/2))*dt;
