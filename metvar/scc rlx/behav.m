...
##      kbhit
      ...
      dkS(and(state_change!=0,prev_state_mat==0)) = (conso_state(state_mat(and(state_change!=0,prev_state_mat==0)),1))/reac_time;
      dkO(and(state_change!=0,prev_state_mat==0)) = (conso_state(state_mat(and(state_change!=0,prev_state_mat==0)),2))/reac_time;
...
##      kbhit
      ...
      if(state_mat(and(state_change!=0,prev_state_mat!=0))!=0&&prev_state_mat(and(state_change!=0,prev_state_mat!=0))!=0)
        dkS(and(state_change!=0,prev_state_mat!=0)) = (conso_state(state_mat(and(state_change!=0,prev_state_mat!=0)),1)-conso_state(prev_state_mat(and(state_change!=0,prev_state_mat!=0)),1))/reac_time ;
        dkO(and(state_change!=0,prev_state_mat!=0)) = (conso_state(state_mat(and(state_change!=0,prev_state_mat!=0)),2)-conso_state(prev_state_mat(and(state_change!=0,prev_state_mat!=0)),2))/reac_time ;
      else
