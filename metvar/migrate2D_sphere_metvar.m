...
function [Grid,kO,kS,kP,DSm,DOm,DPm,state]  = migrate2D_sphere_ctr2(Grid,pos,k,sz,S,P,O,state,kO,kS,kP,kO_tissue,kS_tissue,kP_tissue,DOm,DSm,DPm,DOx_tissue,DS_tissue,DP_tissue)
