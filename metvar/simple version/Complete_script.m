...
full_study('simple','ref_conf','ref');

%substrate starvation
full_study('simple','starv','starv');

%substrate saving
full_study('simple','savy','savy');

%compensation
full_study('simple','compens','compens');

%compensation+prolif
full_study('simple','compens_prol','compens_prol');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%local hypoxia%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
full_study('simple','loc_hypox_base','loc_hypox_base');

full_study('simple','loc_hypox_comp','loc_hypox_comp');

full_study('simple','loc_hypox_comp_prol','loc_hypox_comp_prol');

full_study('simple','loc_hypox_comp_arr','loc_hypox_comp_arr');


%OS models%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
full_study('simple','OS_fragile','OS_fragile');

full_study('simple','OS_hypos_tol','OS_hypos_tol');

full_study('simple','OS_hypox_tol','OS_hypox_tol');

full_study('simple','OS_hypox_boost','OS_hypox_boost');

full_study('simple','OS_hypox_boost_mig','OS_hypox_boost_mig');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
