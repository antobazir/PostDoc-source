...
Grids = load('savy/metvar0','Grid_r').Grid_r;
Grids_Ox = load('savy/metvar0_Ox','Grid_r').Grid_r;

S = load('savy/metvar0','S_r').S_r;
kS = load('savy/metvar0','kS_r').kS_r;
St = load('savy/metvar0','St_r').St_r;
O = load('savy/metvar0','O_r').O_r;
Ot = load('savy/metvar0','Ot_r').Ot_r;
kO = load('savy/metvar0','kO_r').kO_r;
S_Ox = load('savy/metvar0_Ox','S_r').S_r;
kS_Ox = load('savy/metvar0_Ox','kS_r').kS_r;
O_Ox = load('savy/metvar0_Ox','O_r').O_r;
kO_Ox = load('savy/metvar0_Ox','kO_r').kO_r;
dx = load('savy/metvar0','dx').dx;
sz = load('savy/metvar0','sz').sz;
...
print (F,["/home/antony/Documents/Post-doc/test_fortran/metabolic variety/Simple version/plots/savy/C_savy.pdf"], "-dpdflatexstandalone","-S480,360","-FCalibri:22");
...
print (F,["/home/antony/Documents/Post-doc/test_fortran/metabolic variety/Simple version/plots/savy/Cmap_savy_J5.pdf"], "-dpdflatexstandalone","-S480,360","-FCalibri:22");
...
%colorbar(aF);
%axis(aF,[-1000 1000 -1000 1000]);
print (F,["/home/antony/Documents/Post-doc/test_fortran/metabolic variety/Simple version/plots/savy/Cmap_savy_J11.pdf"], "-dpdflatexstandalone","-S480,360","-FCalibri:22");
...
print (F,["/home/antony/Documents/Post-doc/test_fortran/metabolic variety/Simple version/plots/savy/S_savy.pdf"], "-dpdflatexstandalone","-S480,360","-FCalibri:22");
...
colorbar(aF);
%axis(aF,[-2000 2000 -2000 2000]);
print (F,["/home/antony/Documents/Post-doc/test_fortran/metabolic variety/Simple version/plots/savy/O_savy.pdf"], "-dpdflatexstandalone","-S480,360","-FCalibri:22");
...
legend('normal cons.','high cons.','location','northwest')
set(aF,'outerposition',[0.05 0.05 0.9 0.95])
print (F,["/home/antony/Documents/Post-doc/test_fortran/metabolic variety/Simple version/plots/savy/C_savy_in.pdf"], "-dpdflatexstandalone","-S480,360","-FCalibri:22");
...
ylabel(aF,'position (µm)','fontsize',20)
set(aF,'outerposition',[0.05 0.05 0.85 0.95])
text(-0.5*round(sz/2)*dx,-0.5*round(sz/2)*dx,'savy.','color','white','horizontalalignment','center')
text(0.5*round(sz/2)*dx,-0.5*round(sz/2)*dx,'passive','color','white','horizontalalignment','center')
line([0 0], [-round(sz/2)*dx round(sz/2)*dx],'color','white')
%colorbar(aF);
%axis(aF,[-1000 1000 -1000 1000]);
print (F,["/home/antony/Documents/Post-doc/test_fortran/metabolic variety/Simple version/plots/savy/Cmap_savy_in_J4.pdf"], "-dpdflatexstandalone","-S480,360","-FCalibri:22");
...
%colorbar(aF);
%axis(aF,[-1000 1000 -1000 1000]);
print (F,["/home/antony/Documents/Post-doc/test_fortran/metabolic variety/Simple version/plots/savy/Cmap_savy_in_J9.pdf"], "-dpdflatexstandalone","-S480,360","-FCalibri:22");
...
ylabel(aF,'concentration','fontsize',20)
set(aF,'outerposition',[0.05 0.05 0.85 0.95])
text(-0.5*round(sz/2)*dx,0.8,'savy.','horizontalalignment','center')
...
%colorbar(aF1,'gray')
%axis(aF,[-2000 2000 -2000 2000]);
print (F,["/home/antony/Documents/Post-doc/test_fortran/metabolic variety/Simple version/plots/savy/S_savy_in.pdf"], "-dpdflatexstandalone","-S480,360","-FCalibri:22");
...
%colorbar(aF1,'gray')
%axis(aF,[-2000 2000 -2000 2000]);
print (F,["/home/antony/Documents/Post-doc/test_fortran/metabolic variety/Simple version/plots/savy/O_savy_in.pdf"], "-dpdflatexstandalone","-S480,360","-FCalibri:22");
