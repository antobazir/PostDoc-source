...
Grids_Gl = load('hypoxia_A1B1/metvar1_Gl','Grid_r').Grid_r;
Grids_Ox = load('hypoxia_A1B1/metvar1_Ox','Grid_r').Grid_r;

S_Gl = load('hypoxia_A1B1/metvar1_Gl','S_r').S_r;
kS_Gl = load('hypoxia_A1B1/metvar1_Gl','kS_r').kS_r;
St_Gl = load('hypoxia_A1B1/metvar1_Gl','St_r').St_r;
O_Gl = load('hypoxia_A1B1/metvar1_Gl','O_r').O_r;
Ot = load('hypoxia_A1B1/metvar1_Gl','Ot_r').Ot_r;
kO_Gl = load('hypoxia_A1B1/metvar1_Gl','kO_r').kO_r;
S_Ox = load('hypoxia_A1B1/metvar1_Ox','S_r').S_r;
kS_Ox = load('hypoxia_A1B1/metvar1_Ox','kS_r').kS_r;
O_Ox = load('hypoxia_A1B1/metvar1_Ox','O_r').O_r;
kO_Ox = load('hypoxia_A1B1/metvar1_Ox','kO_r').kO_r;
dx = load('hypoxia_A1B1/metvar1_Gl','dx').dx;
sz = load('hypoxia_A1B1/metvar1_Gl','sz').sz;
S_prol = load('hypoxia_A1B1/metvar1_Gl','S_prol').S_prol;
S_maint = load('hypoxia_A1B1/metvar1_Gl','S_maint').S_maint;
O_norm = load('hypoxia_A1B1/metvar1_Gl','O_norm').O_norm;
...
imagesc(((1:sz)-sz/2)*dx,((1:sz)-sz/2)*dx,C1+C2+C3+C4+C5);colorbar
...
print (F,["/home/antony/Documents/Post-doc/test_fortran/metabolic variety/Simple version/plots/hypoxia_A1B1/C_hypoxia_A1B1.pdf"], "-dpdflatexstandalone","-S480,360","-FCalibri:22");
...
print (F,["/home/antony/Documents/Post-doc/test_fortran/metabolic variety/Simple version/plots/hypoxia_A1B1/Cmap_hypoxia_A1B1_J5.pdf"], "-dpdflatexstandalone","-S480,360","-FCalibri:22");
...
%colorbar(aF);
axis(aF,[-2000 2000 -2000 2000]);
print (F,["/home/antony/Documents/Post-doc/test_fortran/metabolic variety/Simple version/plots/hypoxia_A1B1/Cmap_hypoxia_A1B1_J11.pdf"], "-dpdflatexstandalone","-S480,360","-FCalibri:22");
...
%colorbar(aF1,'gray')
%axis(aF,[-2000 2000 -2000 2000]);
print (F,["/home/antony/Documents/Post-doc/test_fortran/metabolic variety/Simple version/plots/hypoxia_A1B1/S_hypoxia_A1B1.pdf"], "-dpdflatexstandalone","-S480,360","-FCalibri:22");
...
colorbar(aF);
%axis(aF,[-2000 2000 -2000 2000]);
print (F,["/home/antony/Documents/Post-doc/test_fortran/metabolic variety/Simple version/plots/hypoxia_A1B1/O_hypoxia_A1B1.pdf"], "-dpdflatexstandalone","-S480,360","-FCalibri:22");
...
##set(aF,'outerposition',[0.05 0.05 0.9 0.95])
##print (F,["/home/antony/Documents/Post-doc/test_fortran/metabolic variety/Simple version/plots/hypoxia_A1B1/C_hypoxia_A1B1_in.pdf"], "-dpdflatexstandalone","-S480,360","-FCalibri:22");
##
...
##ylabel(aF,'position (µm)','fontsize',20)
##set(aF,'outerposition',[0.05 0.05 0.85 0.95])
##text(-0.5*round(sz/2)*dx,-0.5*round(sz/2)*dx,'hypoxia_A1B1.','color','white','horizontalalignment','center')
##text(0.5*round(sz/2)*dx,-0.5*round(sz/2)*dx,'passive','color','white','horizontalalignment','center')
##line([0 0], [-round(sz/2)*dx round(sz/2)*dx],'color','white')
##%colorbar(aF);
##%axis(aF,[-1000 1000 -1000 1000]);
##print (F,["/home/antony/Documents/Post-doc/test_fortran/metabolic variety/Simple version/plots/hypoxia_A1B1/Cmap_hypoxia_A1B1_in_J4.pdf"], "-dpdflatexstandalone","-S480,360","-FCalibri:22");
##
##F = figure('visible','off');
##aF = axes(F);
...
##%colorbar(aF);
##%axis(aF,[-1000 1000 -1000 1000]);
##print (F,["/home/antony/Documents/Post-doc/test_fortran/metabolic variety/Simple version/plots/hypoxia_A1B1/Cmap_hypoxia_A1B1_in_J9.pdf"], "-dpdflatexstandalone","-S480,360","-FCalibri:22");
##
##
##F = figure('visible','off');
##aF = axes(F);
...
##set(aF,'outerposition',[0.05 0.05 0.85 0.95])
##text(-0.5*round(sz/2)*dx,0.8,'hypoxia_A1B1.','horizontalalignment','center')
...
##%colorbar(aF1,'gray')
##%axis(aF,[-2000 2000 -2000 2000]);
##print (F,["/home/antony/Documents/Post-doc/test_fortran/metabolic variety/Simple version/plots/hypoxia_A1B1/S_hypoxia_A1B1_in.pdf"], "-dpdflatexstandalone","-S480,360","-FCalibri:22");
##
##F = figure('visible','off');
##aF = axes(F);
##hold on;
...
##%colorbar(aF1,'gray')
##%axis(aF,[-2000 2000 -2000 2000]);
##print (F,["/home/antony/Documents/Post-doc/test_fortran/metabolic variety/Simple version/plots/hypoxia_A1B1/O_hypoxia_A1B1_in.pdf"], "-dpdflatexstandalone","-S480,360","-FCalibri:22");
