...
##    endif
  ...
  well_fed = and(S>=S_prol,O>=O_norm,Grid!=0,prev_state_mat!=1,LD==1);
  hypox = and(S>=S_prol,O<O_norm,Grid!=0,prev_state_mat!=1,LD==1);
  hypos = and(S<S_prol,S>=S_maint,O>=O_norm,Grid!=0,prev_state_mat!=1,LD==1);
  hypox_hypos = and(S<S_prol,S>=S_maint,O<O_norm,Grid!=0,prev_state_mat!=1,LD==1);
...
##  P_lth_K_rct = and(P>=P_death,K>=K_prom,K<K_death,Grid!=0,kS>0,kO>0);
  ...
  switch(behavior)
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      %enough of both
      conso_state = [0 0;... %starved
      kS_maint kO_tissue;... % hypox hypos
      kS_maint kO_tissue;... % hypos
      kS_tissue kO_tissue;... % hypox
      kS_tissue kO_tissue];   % well fed
      ...
      %enough of both
      conso_state = [0 0;... %starved
      kS_maint 2*kO_tissue;... % hypox hypos
      kS_maint 2*kO_tissue;... % hypos
      kS_tissue kO_tissue;... % hypox
      kS_tissue kO_tissue];   % well fed
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %anything but  well fed stop proliferation & shortage of both kills
      ...
      conso_state = [0 0;... %starved
      0 0;... % hypox hypos
      kS_maint kO_maint;... % hypos
      kS_maint kO_maint;... % hypox
      kS_tissue kO_tissue];   % well fed
   ...
   %enough of both
      conso_state = [0 0;... %starved
      kS_maint kO_maint;... % hypox hypos
      kS_maint 2*kO_maint;... % hypos
      2*kS_tissue kO_maint;... % hypox
      kS_tissue kO_tissue];   % well fed
