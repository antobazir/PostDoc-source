...
function [G,O,D,GD,T,Gt,Ot,Dt,GDt,Tt,kOct,kGt] = modfsys2DA_sym(conf)
...
for i=1:ntime
    ...
    %x-step
    G(2:round(sz/2),2:round(sz/2)) =  G(2:round(sz/2),2:round(sz/2)) + dt*(DG(3:round(sz/2)+1,2:round(sz/2))-DG(1:round(sz/2)-1,2:round(sz/2)))/(4*dx^2).*(G(3:round(sz/2)+1,2:round(sz/2))-G(1:round(sz/2)-1,2:round(sz/2))) + DG(2:round(sz/2),2:round(sz/2))*dt/dx^2.*(G(3:round(sz/2)+1,2:round(sz/2)) -2*(G(2:round(sz/2),2:round(sz/2))) + G(1:round(sz/2)-1,2:round(sz/2))) -kG(2:round(sz/2),2:round(sz/2)).*G(2:round(sz/2),2:round(sz/2)).*D(2:round(sz/2),2:round(sz/2))*dt -kA(2:round(sz/2),2:round(sz/2)).*G(2:round(sz/2),2:round(sz/2))*dt;
    %y-step
    ...
    T(2:round(sz/2),2:round(sz/2)) =  T(2:round(sz/2),2:round(sz/2)) +kO(2:round(sz/2),2:round(sz/2)).*dt.*O(2:round(sz/2),2:round(sz/2)).*GD(2:round(sz/2),2:round(sz/2)) - kT(2:round(sz/2),2:round(sz/2)).*dt.*T(2:round(sz/2),2:round(sz/2)) + kA(2:round(sz/2),2:round(sz/2)).*G(2:round(sz/2),2:round(sz/2))*dt;
