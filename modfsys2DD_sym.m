...
function [G,O,D,GD,T,Gt,Ot,Dt,GDt,Tt,kOct,kGt] = modfsys2DD_sym(conf)
...
for i=1:ntime
    ...
    %x-step
    G(2:round(sz/2),2:round(sz/2)) =  G(2:round(sz/2),2:round(sz/2)) + dt*(DG(3:round(sz/2)+1,2:round(sz/2))-DG(1:round(sz/2)-1,2:round(sz/2)))/(4*dx^2).*(G(3:round(sz/2)+1,2:round(sz/2))-G(1:round(sz/2)-1,2:round(sz/2))) + DG(2:round(sz/2),2:round(sz/2))*dt/dx^2.*(G(3:round(sz/2)+1,2:round(sz/2)) -2*(G(2:round(sz/2),2:round(sz/2))) + G(1:round(sz/2)-1,2:round(sz/2))) -dx/cell_size*kG(2:round(sz/2),2:round(sz/2)).*G(2:round(sz/2),2:round(sz/2)).*D(2:round(sz/2),2:round(sz/2))*dt ;
    %y-step
