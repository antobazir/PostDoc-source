...
for i=1:ntime
    ...
    %explicit  scheme
    %x-step
    G(2:sz-1,:) =  G(2:sz-1,:) + dt*(DG(3:sz,:)-DG(1:sz-2,:))/(4*dx^2).*(G(3:sz,:)-G(1:sz-2,:)) + DG(2:sz-1,:)*dt/dx^2.*(G(3:sz,:) -2*(G(2:sz-1,:)) + G(1:sz-2,:)) -kG(2:sz-1,:).*dt;
    %y-step
...
print (fG, "/home/antony/Documents/Post-doc/test_fortran/plots/RD_G_cons6.pdf", "-dpdflatexstandalone","-S480,360","-FCalibri:22");
print (fGx, "/home/antony/Documents/Post-doc/test_fortran/plots/RD_Gx_cons6.pdf", "-dpdflatexstandalone","-S480,360","-FCalibri:22");
print (fGt, "/home/antony/Documents/Post-doc/test_fortran/plots/RD_Gt_cons6.pdf", "-dpdflatexstandalone","-S480,360","-FCalibri:22");
...
%cons5 unknown cons / my parameters large tissue D 10000 k 10 cell diam 7.5
