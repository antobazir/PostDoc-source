...
%With $[C]$, the concentration of the species, $D$ the diffusion coefficient of the molecule and $k_C$ the consumption of the species by cells. The previous equation is valid only for homogeneous material. In the model presented in this study, diffusion coefficient car vary in space and time which lead to a different formulation in this study : 
